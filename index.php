<?php
 ...
 ?>
    ...
    <div class="best-books-area mt-5">
      <div class="container">
        <div class="">
        ...
        <div class="owl-carousel owl-theme">
          <?php
             ...
             ?>
     <form method="post" action="index.php?action=add&id=<?= $data['id']; ?>" enctype="multipart/form-data">
    <div class="item">
    ...
    <div class="row">
      <?php
       ...
       ?>
        ...
        <div class="col-md-3">
        <form method="post" action="index.php?action=add&id=<?= $data['secbook_id']; ?>" enctype="multipart/form-data">
            <div class="product-wrapper mb-45 text-center">
...
<div class="text-center">
  <a href="all_sec_hand_book.php" class="btn btn-success" type="button" name="button">Show All</a>
    ...
    <div class="donatebook-area my-5" id="donatebook">
      <div class="text-center">
        <h3 class="font-weight-bold text-primary">Donation Books</h3>
      </div>
            ...
            <div class="card card-body mt-3">
                <div class="media align-items-center align-items-lg-start text-center text-lg-left flex-column flex-lg-row">
                    ...
                    <div class="media-body">
                        <h6 class="media-title font-weight-semibold"> <a href="#" data-abc="true"><?= $data['book_title']; ?></a> </h6>
                        <ul class="list-inline list-inline-dotted mb-3 mb-lg-2">
                            <li class="list-inline-item"><a href="#" class="text-muted" data-abc="true"><?= $data['book_category']; ?></a></li>
                        </ul>
                    ...
                    <div class="mt-3 mt-lg-0 ml-lg-3 text-center">
                        <!--<h3 class="mb-0 font-weight-semibold">TK. <?= $data['book_price']; ?></h3>-->
                            ...
                            <div class="events-wrapper events-wrapper-padding">
                                <div class="events-inner d-flex">
                                    <div class="events-thumb">
                                        <a href="event_details.html"><img src="admin/uploads/<?= $data['event_img']; ?>" alt=""></a>
                                    </div>
