                         ...
                         <div class="slider-content slider-content-breadcrumb text-center">
                             ...
                             <nav class="text-center" aria-label="breadcrumb">
                                 <ol class="breadcrumb justify-content-center">
                                     <li class="breadcrumb-item"><a href="index.php">Buy Book</a></li>
               ...
               <div class="col-xl-12">
                   <div class="video-wrapper text-center">
                       <div class="video-content">
                           <a class="popup-video" href="https://www.youtube.com/watch?v=sCbbMZ-q4-I&list=RDMMsCbbMZ-q4-I&start_radio=1"><img src="img/video/play_icon.png" alt=""></a>
            ...
            <?php
                if(!empty($_POST)){
                    ...
                    if(!empty($secbook_title)){
                        ...
                        $insert="INSERT INTO adm_selloldbook(secbook_title,secbook_author,secbook_edition,secbook_price,seller_num,secbook_img)
                        VALUES('$secbook_title','$secbook_author','$secbook_edition','$secbook_price','$seller_num','$imageName')";
